...
OUTPUT_PATH = '13_Application/uniaxial/DIC'
MAX_FORCE = 15000
    ...
    for stage in sorted(list(stages_to_filenames)):
        ...
        if file.endswith(".txt"):
            ...
            if data.force is not None and data.force > MAX_FORCE - 50:
                ...
                out_file.write(
                    f'{file:>80},'
                    f'{cd.crack_tip[0]:>12.5f},{cd.crack_tip[1]:>12.5f},{cd.crack_angle:>12.2f},'
